...
v106 - Horas de Funcionamento: campos de anos, dias e horas agora selecionam todo o valor ao tocar/clicar e substituem imediatamente o valor antigo ao digitar.


v106 - Corrigido comportamento seguro dos campos anos/dias/horas: primeiro dígito substitui o valor antigo sem cursor no meio e sem tela branca.


v106 - Bloco de notas: edição com cursor aproximado ao ponto tocado e scroll mínimo para manter texto acima do teclado, baseada na v102 estável.
